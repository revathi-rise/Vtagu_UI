...
const topMovies = [
  { rank: 1, image: "https://images.unsplash.com/photo-1536440136628-849c177e76a1?q=80&w=600&auto=format&fit=crop", title: "The Revenant" },
  { rank: 2, image: "https://images.unsplash.com/photo-1509281373149-e957c6296406?q=80&w=600&auto=format&fit=crop", title: "Drive" },
  { rank: 3, image: "https://images.unsplash.com/photo-1541873676-a18131494184?q=80&w=600&auto=format&fit=crop", title: "Gravity" },
  { rank: 4, image: "https://images.unsplash.com/photo-1515630278258-407f66498911?q=80&w=600&auto=format&fit=crop", title: "Blade Runner" },
  { rank: 5, image: "https://images.unsplash.com/photo-1518709268805-4e9042af9f23?q=80&w=600&auto=format&fit=crop", title: "Dune" },
  { rank: 6, image: "https://images.unsplash.com/photo-1626814026160-2237a95fc5a0?q=80&w=600&auto=format&fit=crop", title: "Inception" },
  { rank: 7, image: "https://images.unsplash.com/photo-1478479405421-ce83c92fb3ba?q=80&w=600&auto=format&fit=crop", title: "Matrix" },
  { rank: 8, image: "https://images.unsplash.com/photo-1605806616949-1e87b487cb2a?q=80&w=600&auto=format&fit=crop", title: "Mad Max" },
  { rank: 9, image: "https://images.unsplash.com/photo-1535016120720-40c746a6580c?q=80&w=600&auto=format&fit=crop", title: "Interstellar" },
  { rank: 10, image: "https://images.unsplash.com/photo-1485282271306-3bc5562d98ef?q=80&w=600&auto=format&fit=crop", title: "Arrival" },
];
...
export default function Top10Row() {
  return (
    <section className="tv-container mx-auto px-5 tablet:px-10 mb-12 relative z-10 w-full overflow-hidden">
      <h2 className="text-2xl font-extrabold tracking-tight text-white mb-6 drop-shadow-md">
        Top 10 Movies Today
      </h2>
      ...
      <div className="relative group/swiper">
        ...
        >
          {topMovies.map((movie) => (
            <SwiperSlide key={movie.rank} className="group cursor-pointer">
              <div className="relative flex items-end h-[180px] md:h-[240px] w-[95%] mx-auto mt-4 transition-transform duration-300 group-hover:-translate-y-4">
                ...
                <div className="relative w-[65%] md:w-[70%] h-full ml-auto rounded-md overflow-hidden shadow-[0_15px_30px_rgba(0,0,0,0.8)] z-10 transition-transform duration-300 group-hover:scale-[1.05] border border-white/10 group-hover:border-white/30">
                  ...
                  <span className="absolute top-2 right-2 bg-[#e50914] text-[8px] font-black tracking-widest px-1.5 py-0.5 rounded-sm shadow-md">TOP 10</span>
                </div>
              </div>
            </SwiperSlide>
          ))}
